...
class productController extends Controller
{
    ...
    {
        $productColorData = Product::find($request->product_id)
                            ->productColors()->where('id',$prod_color_id)->first();

        $productColorData->update([
            'quantity' => $request->qty
        ]);
        return response()->json(['message' => 'Product Color Qty Updated Successfully']);
    }
    ...
    public function deleteProductColor($prod_color_id)
    {
        ...
        $prodColor->delete();
        return response()->json(['message' => 'Product Color Qty Deleted Successfully']);
