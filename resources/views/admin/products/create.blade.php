                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="featured" name="trending" >
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="mb-3">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="py-2 border mb-3">
                                            ...
                                            {{$coloritem->name}}
                                            <br>
                                            Quantity: <input type="number" name="colorquantity[{{$coloritem->id}}]" style="width:70px; border:1px solid #ddd">
                                        </div>
                                    </div>
                                    @empty
                                    <div class="col-md-12">
