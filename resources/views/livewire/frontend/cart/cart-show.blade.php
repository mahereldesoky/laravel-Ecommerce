        ...
        <div class="container">
                            ...
                            <div class="cart-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-2 col-5 my-auto">
                                        <div class="remove">
                                            <button type="button" wire:loading.attr="disabled" wire:click="removeCartItem({{$cartItem->id}})" href="" class="btn btn-danger btn-sm">
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h4>Get Best deals & Offer <a href="{{url('/collections')}}">Shop Now</a></h4>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        <h4 class="text-primary">
                            taxs:
                            <span class="float-end">{{$tax = $totalPrice * 14/100}} </span>
                        </h4>
                        <h4>Total:
                            <span class="float-end">{{$totalPrice + $tax}} $</span>
                        </h4>
                        <hr>
