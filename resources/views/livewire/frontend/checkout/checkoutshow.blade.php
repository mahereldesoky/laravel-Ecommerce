<div>
    <div class="py-3 py-md-4 checkout">
        <div class="container">
                ...
                <div class="col-md-12 mb-4">
                    <div class="shadow bg-white p-3">
                        <h4 class="text-primary">
                            taxs:
                            <span class="float-end">{{$tax = $this->totalProductAmount * 14/100}} </span>
                        </h4>
                        <h4 class="text-primary">
                            Item Total Amount :
                            <span class="float-end">{{$this->totalProductAmount + $tax}}$</span>
                        </h4>
                        <hr>
                        ...
                        <hr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea id="adress" wire:model.defer="adress" class="form-control" rows="2"></textarea>
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                                ...
                                                <div >
                                                    <button class="btn btn-dark w-50" style=""  wire:click="paidOnlineOrder">
                                                    <a >Pay With Paypal</a>
                                                    </button>
            ...
            @else 
                <div class="card card-body shadow text-center mb-5">
