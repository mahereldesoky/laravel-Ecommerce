    <div>
        <div class="footer-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <h4 class="footer-heading">WorkCrafts</h4>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2"><a href="{{url('/site-map')}}" class="text-white">Sitemaps</a></div>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mb-2">
                            <p>
                                <i class="fa fa-map-marker"></i> Kuwait - Kuwait-city
                            </p>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-phone"></i> +0201111331356
                            </a>
                        </div>
                        <div class="mb-2">
                            <a href="" class="text-white">
                                <i class="fa fa-envelope"></i> maherfared@gmail.com
                            </a>
                        </div>
                    </div>
                </div>
        ...
        <div class="copyright-area">
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class=""> &copy; 2023 - WorckCrafts - Ecommerce. All rights reserved.</p>
                    </div>
                    <div class="col-md-4">
